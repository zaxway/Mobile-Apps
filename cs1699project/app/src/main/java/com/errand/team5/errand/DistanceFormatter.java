...
public final class DistanceFormatter {
     ...
     * @return distance string formatted according to the rules of the formatter.
     */
    public static String format(int distanceInMeters, boolean realTime,int units) {
    ...
    public static String format(int distanceInMeters, boolean realTime, Locale locale) {
        if (useMiles(locale)) {
            return format(distanceInMeters, realTime, locale, 0);
        } else {
            return format(distanceInMeters, realTime, locale, 1);
        }
    }
